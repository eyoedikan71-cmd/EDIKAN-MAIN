...
difficulty = input("Choose level of difficulty[easy, medium, hard]: ")
print(difficulty)
print(f"Difficulty: {difficulty} which is what you chosed")  
...
if difficulty not in levels:
    print("Please either choose easy, medium, or hard.")
...
while attempt_count < attempts:
    ...
    # continue
    if guess == number:
        print(f"\nCongratulations! {args.name} The number was {number}.")
...
#guess = input("what are all your guesses? ")
#print(guess)
#for guess in args.guesses:
#for user_guess in guess:
